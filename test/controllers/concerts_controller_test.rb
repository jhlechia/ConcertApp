...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { artist: @concert.artist, date: @concert.date, user_id: @concert.user_id, venue: @concert.venue }
    end
  ...
  test "should update concert" do
    patch :update, id: @concert, concert: { artist: @concert.artist, date: @concert.date, user_id: @concert.user_id, venue: @concert.venue }
    assert_redirected_to concert_path(assigns(:concert))
  end
